...
type LeaveApprovalClientProps = {
  ...
  historyRows: LeaveApprovalHistoryRow[]
}

export type LeaveApprovalHistoryRow = LeaveApprovalRow & {
  decidedAtIso: string
...
export function LeaveApprovalClient({ companyId, isHR, rows, historyRows }: LeaveApprovalClientProps) {
  ...
  const filteredHistoryRows = useMemo(() => {
    ...
    return historyRows.filter((row) => {
      ...
      return (
        ...
        row.leaveTypeName.toLowerCase().includes(search) ||
