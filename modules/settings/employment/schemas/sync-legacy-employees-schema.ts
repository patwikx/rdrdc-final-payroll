...
export const syncLegacyEmployeesInputSchema = z.object({
  ...
  apiToken: z
    ...
    .optional()
    .transform((value) => value || undefined),
  employeeEndpoint: endpointSchema.default("/api/migration/employees"),
  timeoutMs: z
    .number()
    .int()
...
export type SyncLegacyEmployeesInput = z.infer<typeof syncLegacyEmployeesInputSchema>
