...
export default function PayrollRecurringEarningsLoading() {
  return (
              ...
              <tbody>
                {Array.from({ length: 7 }).map((_, index) => (
                  <tr key={String(index)} className="border-b border-border/50">
                    <td className="px-3 py-2.5"><Skeleton className="h-8 w-36" /></td>
                    ...
                    <td className="px-3 py-2.5"><Skeleton className="h-6 w-20" /></td>
                    <td className="px-3 py-2.5"><Skeleton className="h-8 w-8" /></td>
                  </tr>
                ))}
              </tbody>
            </table>
