...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      title: `Material Request Approvals | ${company.companyName} | Final Payroll System`,
      description: `Configure department material request approval flows for ${company.companyName}.`,
    }
  } catch {
    return {
      title: "Material Request Approvals | Final Payroll System",
      description: "Configure department material request approval flows.",
    }
  }
}

export default async function MaterialRequestSettingsRoutePage({ params }: MaterialRequestSettingsRouteProps) {
